!function(n) {
    ...
    t.prototype.initMenu=function() {
        ...
        n(".side-nav").length&&(t=n(".side-nav li .collapse"),
        n(".side-nav li [data-bs-toggle='collapse']").on("click",
        function(t) {
            return!1
        }
        ),
...
function(a) {
    ...
    t.prototype.initMenu=function() {
        ...
        document.querySelectorAll("ul.navbar-nav .dropdown .dropdown-toggle").forEach(function(e) {
            e.addEventListener("show.bs.dropdown", function(t) {
                null!=e.parentElement.closest(".dropdown-menu ")&&(t.stopPropagation(), e.parentElement.closest(".dropdown-menu ").classList.add("show"), e.parentElement.parentElement.parentElement.querySelector(".nav-link").ariaExpanded=!0, e.parentElement.parentElement.parentElement.querySelector(".nav-link").classList.add("show"))
            }
            ),
            e.addEventListener("hide.bs.dropdown",
            function(t) {
                t.stopPropagation(), null!=e.parentElement.closest(".dropdown-menu ")&&(e.parentElement.closest(".dropdown-menu ").classList.add("show"), e.parentElement.parentElement.parentElement.querySelector(".nav-link").ariaExpanded=!0, e.parentElement.parentElement.parentElement.querySelector(".nav-link").classList.add("show"))
            }
            ),
            e.addEventListener("hidden.bs.dropdown",
            function(t) {
                console.log(t)
            }
            ),
            e.addEventListener("shown.bs.dropdown",
            function(t) {
                console.log("Shown"), console.log(t)
            }
            )
        }
        )
...
function(a) {
    ...
    t.prototype._selectOptionsFromConfig=function() {
        ...
        if(t) {
            switch(console.log(a("input[type=checkbox]")), a("input[type=checkbox]").prop("checked", !1), t.sideBarTheme) {
            ...
            t.isCondensed&&a("#condensed-check").prop("checked",!0),t.isScrollable&&a("#scrollable-check").prop("checked",!0),
    ...
    t.prototype.init=function() {
        ...
        a("input[type=checkbox][name=theme]").change(function() {
            switch(console.log(a(this).val()), a(this).val()) {
        ...
        a("input[type=checkbox][name=color-scheme-mode]").change(function() {
            switch(a(this).val()) {
                case"light": a.App.deactivateDarkMode(), a.App.activateDefaultSidebarTheme(), a("#default-check").prop("checked", !0), a("input[type=checkbox][name=theme]").prop("disabled", !1);
                break;
...
function(a) {
    ...
    t.prototype._getStoredConfig=function() {
        var t=this.body.data("layoutConfig"), e=i;
    ...
    t.prototype._applyConfig=function() {
        ...
        switch(this._config=this._getStoredConfig(), a.LeftSidebar.init(), t._config.sideBarTheme) {
            case n: t.activateDarkSidebarTheme();
            break;
            case o: t.activateLightSidebarTheme()
        }
    ...
    t.prototype.activateFluid=function() {
        ...
        this.body.attr("data-layout-mode",
        "fluid")
    }
    ,
    ...
    t.prototype.activateDarkMode=function() {
        a("#light-style").attr("disabled", !0), a("#dark-style").attr("disabled", !1), a.LeftSidebar.activateDarkTheme(), this._saveConfig( {
            isDarkModeEnabled: !0, sideBarTheme: n
        }
        )
    }
    ,
    t.prototype.deactivateDarkMode=function() {
        a("#light-style").attr("disabled", !1), a("#dark-style").attr("disabled", !0), this._saveConfig( {
            isDarkModeEnabled: !1
        }
        )
    }
...
function(i) {
    ...
    t.prototype.initDateRange=function() {
        ...
        ;
        i('[data-toggle="date-picker"]').each(function(t,
        e) {
        ...
        var n= {
            startDate: moment().subtract(29, "days"), endDate: moment(), ranges: {
                Today: [moment(), moment()], Yesterday: [moment().subtract(1, "days"), moment().subtract(1, "days")], "Last 7 Days": [moment().subtract(6, "days"), moment()], "Last 30 Days": [moment().subtract(29, "days"), moment()], "This Month": [moment().startOf("month"), moment().endOf("month")], "Last Month": [moment().subtract(1, "month").startOf("month"), moment().subtract(1, "month").endOf("month")]
            }
        }
        ;
        i('[data-toggle="date-picker-range"]').each(function(t,
        e) {
    ...
    t.prototype.initTimePicker=function() {
        ...
        ;
        i('[data-toggle="timepicker"]').each(function(t,
        e) {
            var a=i.extend( {}, o, i(e).data());
            i(e).timepicker(a)
        }
    ...
    t.prototype.initMaxlength=function() {
        /*
        var o= {
            warningClass: "badge bg-success", limitReachedClass: "badge bg-danger", separator: " out of ", preText: "You typed ", postText: " chars available.", placement: "bottom"
        };
...
function(c) {
    "use strict";
    function t() {}t.prototype.send=function(t, e, a, o, n, i, r, s) {
        var d= {
            heading: t, text: e, position: a, loaderBg: o, icon: n, hideAfter: i=i||3e3, stack: r=r||1
        }
        ;
    ...
    t.prototype.initSyntaxHighlight=function() {
        a(document).ready(function(t) {
            document.querySelectorAll("pre span.escape").forEach(function(t, e) {
                ...
                n<o.length;
                n++)o[n].trim()&&(a=Math.min(o[n].search(/\S/), a));
                for(var i=[], n=0;
                n<o.length;
                n++)i.push(o[n].replace(new RegExp("^ {"+a+"}", "g"), ""));
                t.innerText=i.join("\n")
            }
            ),
...
function(a) {
    ...
    t.prototype.init=function() {
        ...
        window.sessionStorage&&t&&t.hasOwnProperty("showRightSidebarOnStart")&&t.showRightSidebarOnStart&&(sessionStorage.getItem("_HYPER_VISITED_")||(sessionStorage.setItem("_HYPER_VISITED_",!0))),
        a.Portlet.init(),
